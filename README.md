...
## 功能介绍
### 首页预览  
  ![alt 首页](https://github.com/CandyTiaoTiao/o365/blob/master/pic/001.PNG)
...
### [配置和报告] -> Office配置  
  - **新增**  
    将刚才得到的3个要素填入
    ![alt 填入APP信息](https://github.com/CandyTiaoTiao/o365/blob/master/pic/002.PNG)  
    PS 配置根据备注排序，如果你想要有序，可以设置备注  
  - **删除**，**修改**，**刷新**不做介绍  
  - **导入**  
    如果不想麻烦，也可以使用导入功能，先下载模板，填写好信息后，可以批量导入  
    ![alt 导入](https://github.com/CandyTiaoTiao/o365/blob/master/pic/003.PNG)  
  - **导出**  
    将所有APP信息导出为csv文件  
  - **切换全局**  
    选中一行后，点击切换全局，O365很多的TAB工作的前提是需要有一个当前全局为是的APP，被选中的行将会以浅蓝色标记  
    ![alt 切换全局](https://github.com/CandyTiaoTiao/o365/blob/master/pic/004.PNG)  
  - **更新密钥**  
    将创建一个过期时间为2099-12-31的新密钥，成功后会替换现有密钥，若不想更改现有密钥，请取消  
    ![alt 更新密钥](https://github.com/CandyTiaoTiao/o365/blob/master/pic/005.PNG)  
  - **校验**  
    校验只验证APP 3要素的正确性(**不包含权限的校验**)
  - **生成报告**  
    选一行后，点击此按钮，会生成总览报告，此报告可以在Office总览报告中找到  
    ![alt 更新密钥](https://github.com/CandyTiaoTiao/o365/blob/master/pic/006.PNG)  
  - **On/Off**  
    显示/隐藏APPID和密钥  
  - **帮助**  
    有什么问题，你可以尝试点击帮助了解更多  
...
### [用户] -> 管理用户  
  ![alt 用户首页](https://github.com/CandyTiaoTiao/o365/blob/master/pic/007.PNG)  
  - **添加**  
    ![alt 添加](https://github.com/CandyTiaoTiao/o365/blob/master/pic/007.5.PNG)  
  - **批量添加**  
    批量添加有2种策略，一种是随机5字符，另外一种是自增长数字  
    ![alt 批量添加](https://github.com/CandyTiaoTiao/o365/blob/master/pic/008.PNG)  
  - **删除**，**刷新**不做介绍  
  - **启用**，**禁用**  
    分别为启用和禁用选中的用户  
  - **提权**，**撤权**  
    ...
    ![alt 批量添加](https://github.com/CandyTiaoTiao/o365/blob/master/pic/009.PNG)  
  - **域名**  
...
### [用户] -> 查看特权用户  
  ![alt 查看特权用户](https://github.com/CandyTiaoTiao/o365/blob/master/pic/010.PNG)  
### [许可证] -> 查看许可证  
  ![alt 查看许可证](https://github.com/CandyTiaoTiao/o365/blob/master/pic/011.PNG)  
### [配置和报告] -> Office总览报告  
  - **手动执行**  
    生成所有全局的总览报告，此报告包含总用户数，管理员数和SPO可用性  
    ![alt 查看许可证](https://github.com/CandyTiaoTiao/o365/blob/master/pic/012.PNG)  
    + 灰色代表无效全局  
...
### [配置和报告] -> 系统配置  
  ...
  WX_AGENTID  
  WX_CALLBACK_AESKEY  
  以上6个参数的设置请参考word文档, https://github.com/CandyTiaoTiao/o365/blob/master/docs/%E9%85%8D%E7%BD%AE%E5%BE%AE%E4%BF%A1%E5%93%8D%E5%BA%94.docx  
  **请谨慎使用，此6个变量的配置非必须，只是为了增强管理员账号的安全，如果未通过，请立即把WX_CALLBACK_IND设为N，避免把自己关外面**

# Docker 
### 基于v2.0版的docker
```bash
docker pull aigaoya/o365
docker run -d -p 9281:9281 aigaoya/o365

#如果你之前使用过，但是不想手动迁移数据，那么可以这样做，/root/o365/data是你本地的文件夹
#建议使用这种方法，以后你如果想要迁移数据，直接拷贝/root/o365/data文件就行了
docker run -d -p 9281:9281 -v /root/o365/data:/data aigaoya/o365
```
### 手动构建master分支的docker  
docker build -t aigaoya/o365 https://github.com/CandyTiaoTiao/o365.git#master  
