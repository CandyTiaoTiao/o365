...
--CF info
insert into ta_master_cd(key_ty,cd,decode,start_dt,end_dt,create_dt,last_update_id,last_update_dt) values ('CF_AUTH_EMAIL','314939840@qq.com','注册在CF的邮件',sysdate,null,sysdate,'o365',sysdate);
