...
public class InviteTabCtrl {
    ...
    @RequestMapping(value = {"/tabs/invite.html", "/tabs/invite"}) // 同时支持 .html 和 裸路径
    public String dummy() {
        return "tabs/invite";
    }
    
    @RequestMapping(value = {"/tabs/dialogs/createInviteCd.html", "/tabs/dialogs/createInviteCd"}) // 同时支持
    ...
    // 关键修改点：在 value 数组中增加 "/refer"
    @RequestMapping(value = {"/refer.html", "/refer"}) 
